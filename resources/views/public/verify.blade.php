{{--
    VeriVote NG Public Verification

    Presents a read-only public integrity record for a recorded polling-unit
    result, including verification status, cryptographic evidence,
    deterministic checks, discrepancies, and audit information.
--}}
...
<head>
    ...
    <title>
        VeriVote NG — Public Verification #{{ $result->id }}
    </title>
</head>
...
<body>
    <main>
        <header>
            ...
            <p>
                Read-only integrity record for Result #{{ $result->id }}.
            </p>
        </header>
