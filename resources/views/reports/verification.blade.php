        ...
        <div class="shell topbar-inner">
            <a href="{{ route('home') }}" class="brand">
                ...
                <span class="brand-copy">
                    ...
                    <span class="brand-subtitle">Verification Report</span>
                </span>
            </a>

            <a
                href="{{ route('public.verify', $result) }}"
                class="topbar-link"
            >
    ...
    <main>
        <div class="shell">
            ...
            <section class="intro">
                ...
                <p>
                    A structured integrity report for Result #{{ $result->id }},
                    containing its recorded result data, cryptographic evidence,
                    deterministic verification checks, discrepancies, and audit
                    references.
                </p>
            </section>

            <section
                class="status-card {{ $isVerified ? 'verified' : ($isFlagged ? 'flagged' : '') }}"
            >
                <div class="status-layout">
                    <div>
                        ...
                        <p class="status-description">
                            @if ($isVerified)
                                All recorded deterministic verification checks
                                currently pass for this result.
                            @elseif ($isFlagged)
                                One or more integrity checks failed and require
                                human investigation.
                            @else
                                This result has not reached a final verification
                                state.
                            @endif
                        </p>
                    </div>
            ...
            <div class="grid">
                ...
                <section class="card">
                    <div class="card-heading">
                        ...
                        <p>
                            Core election and polling-unit identity.
                        </p>
                    </div>
                    ...
                    <div class="details">
                        ...
                        <div class="detail">
                            <span class="detail-label">Polling Unit Code</span>
                            <span class="detail-value">
                        ...
                        <div class="detail">
                            <span class="detail-label">Polling Unit Name</span>
                            <span class="detail-value">
                ...
                <section class="card">
                    <div class="card-heading">
                        ...
                        <p>
                            Recorded ballot and voter figures.
                        </p>
                    </div>
                    ...
                    <div class="details">
                        ...
                        <div class="detail">
                            <span class="detail-label">Total Valid Votes</span>
                            <span class="detail-value">
                ...
                <section class="card full">
                    <div class="card-heading">
                        ...
                        <p>
                            Vote entries recorded against this result.
                        </p>
                    </div>
                ...
                <section class="card full">
                    <div class="card-heading">
                        ...
                        <p>
                            Cryptographic information associated with the recorded
                    ...
                    <div class="details">
                        <div class="detail">
                            <span class="detail-label">Payload SHA-256</span>
                ...
                <section class="card full">
                    <div class="card-heading">
                        ...
                        <p>
                            Evidence records associated with this result.
                        </p>
                    </div>
                                ...
                                <article class="evidence-item">
                                    ...
                                    <div class="evidence-meta">
                                        ...
                                        @if ($evidence->captured_at)
                                            <div>
                                                Captured:
                                                {{ $evidence->captured_at->format('Y-m-d H:i:s') }}
                                            </div>
                                        @endif
                                    </div>
                                </article>
                ...
                <section class="card full">
                    <div class="card-heading">
                        ...
                        <p>
                            Verification rules executed against the recorded
                            result.
                        </p>
                    </div>
                    ...
                    @if ($result->verificationChecks->isNotEmpty())
                        <div class="check-list">
                            @foreach ($result->verificationChecks as $check)
                                <article
                                    class="check {{ $check->passed ? 'passed' : 'failed' }}"
                                >
                ...
                <section class="card full">
                    <div class="card-heading">
                        <h2>Discrepancies</h2>
                        <p>
                            Integrity discrepancies requiring human investigation.
                        </p>
                    </div>

                    @if ($result->discrepancies->isNotEmpty())
                        @foreach ($result->discrepancies as $discrepancy)
                            <article class="discrepancy">
                ...
                <section class="card full">
                    <div class="card-heading">
                        ...
                        <p>
                            Recorded audit events and integrity-chain references.
                        </p>
                    </div>
            ...
            <section class="notice">
                <p>
                    ...
                    detection. A flagged result identifies an integrity
                    discrepancy requiring human investigation; it does not by
                    itself establish the cause of that discrepancy.
                </p>
            </section>
